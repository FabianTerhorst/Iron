...
```groovy
compile 'io.fabianterhorst:iron:0.6.2'
...
compile 'com.github.fabianterhorst.iron:iron-retrofit:0.6.2'
compile 'com.github.fabianterhorst.iron:iron:0.6.2'
compile 'com.github.fabianterhorst.iron:iron-encryption:0.6.2'
//is only required for using the compiler
compile 'com.github.fabianterhorst.iron:iron-annotations:0.6.2'
apt 'com.github.fabianterhorst.iron:iron-compiler:0.6.2'
```
